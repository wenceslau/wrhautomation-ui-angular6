...
@Component({
  selector: 'app-payroll-dre-report',
  templateUrl: './payroll-dre-report.component.html',
  styleUrls: ['./payroll-dre-report.component.css']
})
export class PayrollDreReportComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.referenceMonth = this.getReferenceMonth();
    this.reportService.payrollDreReport(this.referenceMonth)
      .then(relatorio => {
  ...
  private trace(value: string) {
    console.log('PayrollDreReportComponent:' + value);
  }
}
